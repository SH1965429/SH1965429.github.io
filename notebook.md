...
| data type| The kind of value a variable holds, like numbers or text. | `int`, `String`, `bool` | yo function correctly  |  |
...
|  Class   | Blueprint for creating objects with specific structure and behavior. | `class Dog {}` | learning |  |
|  Object  | A specific version of a class. | `Dog myDog = Dog();` |  |  |
| property | A variable that belongs to a class/object. | `String name;` |  |  |
|  method  | A function that belongs to a class. | `void bark() {}` |  |  |
|Constucter| A special function used to set up a class when it’s created. | `Dog(this.name);` |  |  |
